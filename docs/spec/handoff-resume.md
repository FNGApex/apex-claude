...
| 7 | `commands/ax-resume.md`: `handoff status` → route 0/1/2 → reconcile vs `handoff scan` → confirm → `handoff archive` on accept | `commands/ax-resume.md` | `apex validate` passes |
